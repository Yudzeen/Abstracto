...
public class Slice extends ScreenTransition {
    ...
    public static ScreenTransition init(float duration, int direction, int numSlices, Interpolation easing) {
    ...
    public void render(SpriteBatch batch, Texture currScreen, Texture nextScreen, float alpha) {
        ...
        for (int i = 0; i < sliceIndex.size; i++) {
            ...
            batch.draw(nextScreen,x,y,0,0,sliceWidth,h,1,1,0,(int)(i*sliceWidth),0,(int)sliceWidth,nextScreen.getHeight(),false, true);
        }
        batch.end();
    }
}
