...
class InfoPage3 extends AbstractoScreen {
    ...
    private void initEnqueueLabel() {
        enqueueLabel = LabelFactory.createLabel("ENQUEUE", assets.fonts.chalk_30, Color.WHITE);
        enqueueLabel.setPosition(110, GameConstants.HEIGHT - enqueueLabel.getHeight() - 120);
    }

    private void initDescriptionLabel() {
        String text = "- inserts at the tail of the queue";
    ...
    private void initNodeImage1() {
        ...
        nodeImage1.setPosition(queueImage.getX() - nodeImage1.getWidth()*1/4,
    ...
    private void initArrowImage() {
        ...
        arrowImage.setPosition(queueImage.getX() + queueImage.getWidth()/2 - arrowImage.getWidth()/2 + 40,
                nodeImage1.getY() + 53);
    }
