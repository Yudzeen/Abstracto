...
public class CustomerCashierScreen extends AbstractoScreen {
    ...
    public static class InstructionScreen extends AbstractoScreen {
        ...
        final String TAG = InstructionScreen.class.getName();
        ...
        private void initBodyLabel() {
            String text = "- Simulate a customer cashier queue.\n\n" +
                    "- Enqueue the customers by dragging into the queue.\n\n" +
                    "- Tap the customers after they order to dequeue.\n\n" +
