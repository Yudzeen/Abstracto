...
/**
 * Balancing Symbol Instruction Screen
 */

public class InstructionScreen extends AbstractoScreen {

    static final String TAG = InstructionScreen.class.getName();
    ...
    private void initBodyLabel() {
        String text = "- Validate that the grouping symbols match \n  and is balanced by pushing or popping " +
                "the\n  current node\n\n" +
                "- Avoid mistakes and finish before \n  the time runs out";
